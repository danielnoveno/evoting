...
export const adminElectionDummyData: AdminElectionRecord[] = [
  ...
  {
    id: 'ketua-kelompok-praktikum-basis-data-2025',
    title: 'Pemilihan Ketua Kelompok Praktikum Basis Data 2025',
    meta: 'Selesai 20 Sep 2025 • Partisipasi 94%',
    status: 'selesai',
    badge: 'Finalized',
    iconTone: 'blue',
    ...
    turnoutLabel: '32 pemilih terdaftar',
    detail: {
      statusPill: 'Final',
      candidates: [
        {
          ...
          summary: 'Koordinasi tugas praktikum yang rapi dan komunikasi kelompok yang cepat.',
          imageTone: 'dark',
          identityNumber: '220713021',
          bio: 'Aktif membantu koordinasi kelas dan terbiasa menyusun pembagian tugas praktikum.',
          vision: 'Membangun kelompok praktikum yang disiplin, komunikatif, dan saling membantu.',
          mission: 'Menyusun jadwal internal; memastikan setiap anggota mendapat peran jelas; dan menjaga komunikasi rutin dengan asisten.',
        },
        {
          id: 'cand-22',
          number: '02',
          ...
          summary: 'Fokus pada pembagian tugas yang adil dan dokumentasi progres mingguan.',
          imageTone: 'neutral',
          identityNumber: '220713022',
          bio: 'Sering menjadi koordinator kecil dalam tugas kelompok dan dokumentasi laporan.',
          vision: 'Mewujudkan kelompok praktikum yang tertib, transparan, dan tepat waktu.',
          mission: 'Membagi peran sesuai kekuatan anggota; mencatat progres tiap pertemuan; dan menjaga kualitas laporan akhir.',
        },
        {
          id: 'cand-23',
          number: '03',
          name: 'Laras Putri',
          faculty: 'Informatika ’23',
          summary: 'Menekankan suasana kerja kolaboratif dan kesiapan presentasi kelompok.',
          imageTone: 'neutral',
          identityNumber: '220713023',
          bio: 'Aktif dalam diskusi kelas dan terbiasa mempersiapkan presentasi kelompok.',
          vision: 'Mendorong kelompok praktikum yang suportif, siap presentasi, dan konsisten mengumpulkan tugas.',
          mission: 'Menyusun ritme kerja mingguan; menjaga komunikasi antaranggota; dan memastikan kesiapan presentasi sebelum deadline.',
        },
      ],
      ...
      whitelist: createWhitelistDetail('30', '32', '0x44F2B7A9C1D3E5F7A9C1D3E5F7A9C1D3E5F7A9', [
        { wallet: '0x5f2...9A2e', name: 'Nicolas Suryanto', status: 'verified', addedAt: '18 Sep 2025' },
        { wallet: '0x6b1...3F10', name: 'Clara Mutiara', status: 'verified', addedAt: '18 Sep 2025' },
        { wallet: '0x7d9...1a55', name: '—', status: 'pending', addedAt: 'Baru saja' },
        { wallet: '0x84a...F201', name: 'Reza Hidayat', status: 'verified', addedAt: '17 Sep 2025' },
      ]),
      ...
      realtime: createRealtimeDetail('30', '32', '93.8%', 'w-[93.8%]', [
        { candidateNumber: '01', candidateName: 'Gina Maharani', votes: '12', percentage: '40.0%', barWidthClassName: 'w-[40%]', tone: 'primary' },
        { candidateNumber: '02', candidateName: 'Kevin Adinata', votes: '10', percentage: '33.3%', barWidthClassName: 'w-[33.3%]', tone: 'secondary' },
        { candidateNumber: '03', candidateName: 'Laras Putri', votes: '8', percentage: '26.7%', barWidthClassName: 'w-[26.7%]', tone: 'secondary' },
      ]),
      monitoring: createMonitoringDetail({
        title: 'Detail Log Audit',
        description: 'Rekap aktivitas finalisasi dan sinkronisasi hasil untuk audit pemilihan ketua kelompok praktikum.',
        currentPhase: 'ENDED',
  ...
  "blockchain": "Base Sepolia Testnet"
        ...
        logRows: [
          { time: '20 Sep 2025', timeMeta: '18:10:14 UTC', rangeKey: 'hari-ini', category: 'Update Phase', actorName: 'Asisten Praktikum', actorWallet: '0x7fd ... 883', action: 'Finalize Election', actionTone: 'blue', objectTitle: 'Pemilihan Ketua Kelompok Praktikum', objectMeta: 'Result Locked', status: 'selesai', hash: '0x811 ... f90' },
          { time: '20 Sep 2025', timeMeta: '18:06:03 UTC', rangeKey: 'hari-ini', category: 'Sinkronisasi', actorName: 'Votein System', actorWallet: 'Automated (Cron)', action: 'Sync Blockchain State', actionTone: 'slate', objectTitle: 'Node Admin FTI', objectMeta: 'Final snapshot written', status: 'selesai', hash: '0x44d ... 221' },
        ],
      }),
      candidateForm: {
        breadcrumbParent: 'Manajemen Pemilihan',
        breadcrumbCurrent: 'Tambah Kandidat',
        title: 'Profil Kandidat',
        description: 'Lengkapi profil kandidat untuk pemilihan Ketua Kelompok Praktikum Basis Data. Pastikan identitas mahasiswa tercatat lengkap sebelum finalisasi.',
        uploadLabel: 'Foto Kandidat',
        uploadHint: 'Seret foto ke sini atau klik untuk unggah',
        uploadSupport: 'JPG, PNG (Maks 5MB)',
        identityLabel: 'ID Pemilih / NPM',
  ...
  "blockchain": "Base Sepolia Testnet"
        ...
        logRows: [
          ...
          { time: '11 Mei 2026', timeMeta: '15:02:31 UTC', rangeKey: 'hari-ini', category: 'Sinkronisasi', actorName: 'Votein System', actorWallet: 'Automated (Cron)', action: 'Sync Blockchain State', actionTone: 'slate', objectTitle: 'Node Panitia UKM', objectMeta: 'Final record synced', status: 'selesai', hash: '0xbbc ... 331' },
        ],
      }),
      candidateForm: {
        breadcrumbParent: 'Manajemen Pemilihan',
